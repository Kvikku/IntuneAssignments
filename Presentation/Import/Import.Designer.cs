namespace IntuneAssignments.Presentation.Import
{
    partial class Import
    {
        ...
        private void InitializeComponent()
        {
            ...
            clbContentTypes.Items.AddRange(new object[] { "Settings Catalog", "Device Compliance", "Device Configuration", "PowerShell script", "Proactive Remediations", "Application", "macOS script", "Group Policy Configuration" });
